...
class GuildsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guild" do
    assert_difference('Guild.count') do
      post guilds_url, params: { guild: { anagram: @guild.anagram, is_making_war: @guild.is_making_war, name: @guild.name, owner_id: @guild.owner_id, points: @guild.points } }
    end
  ...
  test "should update guild" do
    patch guild_url(@guild), params: { guild: { anagram: @guild.anagram, is_making_war: @guild.is_making_war, name: @guild.name, owner_id: @guild.owner_id, points: @guild.points } }
